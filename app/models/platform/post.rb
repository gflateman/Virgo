module Platform
  class Post < ActiveRecord::Base
    ...
    belongs_to :author, class_name: 'Platform::User'

    belongs_to :featured_image, class_name: 'Platform::Image'
    belongs_to :thumbnail_image, class_name: 'Platform::Image'

    belongs_to :created_by, class_name: 'Platform::User'

    belongs_to :editing_user, class_name: 'Platform::User'
