module Platform
  class ApplicationController < ActionController::Base
    ...
    def render_500(exception)
      ...
      render "platform/errors/500", layout: "platform/errors", status: 500
    end
    ...
    def render_404
      if request.format.json? || request.format.js?
        ...
        render "platform/errors/404", layout: "platform/errors", status: 404
      end
    end
    ...
    def after_sign_out_path_for(resource_or_scope)
      platform.new_user_session_path
    end
